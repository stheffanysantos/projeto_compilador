// Generated from AnalisadorLexicoLexer.g4 by ANTLR 4.13.1
...
public class AnalisadorLexicoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAM", "INTEGER", "BOOLEAN", "STRING", "BEGIN", "END", "IF", "THEN", 
			"ELSE", "WHILE", "DO", "READ", "VAR", "FALSE", "TRUE", "WRITE", "OR", 
			"AND", "MENOR_IG", "MAIOR_IG", "IGUAL", "DIFERENTE", "MENOR", "MAIOR", 
			"MAIS", "MENOS", "VEZES", "DIV", "NEGACAO", "ATRIB", "PONTO_VIG", "PONTO", 
			"DPONTOS", "VIRGULA", "ABRE_PAR", "FECHA_PAR", "CTE", "CADEIA", "ID", 
			"COMENTARIO", "ESPACO", "DIGITO", "LETRA", "A", "B", "C", "D", "E", "F", 
	...
	public AnalisadorLexicoLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "AnalisadorLexicoLexer.g4"; }
